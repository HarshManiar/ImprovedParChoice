...
acc = clf.accuracy(pc_tgt, [0 for i in range(len(pc_tgt))])
...
acc = clf.accuracy(tr_tgt, [0 for i in range(len(tr_tgt))])
...
acc = clf.accuracy(pc_tr_tgt, [0 for i in range(len(pc_tr_tgt))])
...
acc = clf.accuracy(tr_pc_tgt, [0 for i in range(len(tr_pc_tgt))])
...
acc = clf.accuracy(hy_tgt, [0 for i in range(len(hy_tgt))])
